...
public class QuitLogger {
    ...
    public void quitCucumber(PlayerQuitEvent e){
        ...
        if(world.getBlockAt(location).getType()==Material.LAVA){
            e.setQuitMessage(ChatColor.GREEN+"오이사우르스"+ChatColor.YELLOW+"가 용암에 빠진 것 같습니다.");
        }
        alertQuit();
    }
    ...
    public void quitAndesite(PlayerQuitEvent e){
        ...
        if(world.getBlockAt(location).getType()==Material.LAVA){
            e.setQuitMessage(ChatColor.GOLD+"데스"+ChatColor.YELLOW+"가 용암에 빠진 것 같습니다.");
        }
    ...
    public void quitSeo_m(PlayerQuitEvent e){
        ...
        if(world.getBlockAt(location).getType()==Material.LAVA){
            e.setQuitMessage(ChatColor.AQUA+"서엠"+ChatColor.YELLOW+"이 용암에 빠진 것 같습니다.");
        }
    ...
    public void quitDefault(PlayerQuitEvent e){
        ...
        if(world.getBlockAt(location).getType()==Material.LAVA){
            e.setQuitMessage(ChatColor.DARK_GREEN+e.getPlayer().getName()+ChatColor.YELLOW+"가 용암에 빠진 것 같습니다.");
        }
